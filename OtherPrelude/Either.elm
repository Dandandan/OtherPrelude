module OtherPrelude.Either where
...
isLeft = either (always True) (always False)
...
consRight e vs = either (always vs) (\v -> v::vs) e

consEither e (ls,rs) = either (\l -> (l::ls, rs)) (\r -> (ls,r::rs)) e
